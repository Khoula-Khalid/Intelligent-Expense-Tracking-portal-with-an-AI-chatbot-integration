...
function CardInfo({ totalIncome, budgetList }) {
  ...
  return (
    <div>
      {budgetList?.length > 0 ? (
        <div className='mt-5 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-5'>
        ...
        <div className='mt-7 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-5'>
